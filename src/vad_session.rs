...
impl VadSession {
    ...
    pub fn new(model_location: &str) -> Result<Self, Error> {
...
mod tests {
    ...
    fn test_struct() {
        ...
        let mut silero_model = VadSession::new("/Users/oliver.pikett/Documents/GitHub/silero-rs/files/silero_vad.onnx").unwrap();
